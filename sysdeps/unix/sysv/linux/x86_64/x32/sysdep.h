...
#define	POPARGS_1	POPARGS_0; movl %r9, %rbx; L(RESTBX1):
#define	_PUSHARGS_1	pushl %rbx; cfi_adjust_cfa_offset (8); \
...
#define _POPARGS_6	_POPARGS_5; popq %ebp; cfi_adjust_cfa_offset (-8); \
